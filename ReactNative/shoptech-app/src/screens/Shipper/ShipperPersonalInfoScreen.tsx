        ...
        try {
            ...
            if (!result.canceled && result.assets && result.assets.length > 0) {
                ...
                const uploadRes: any = await axiosClient.post('/files/upload', formData, {
                    ...
                    transformRequest: () => formData, // Bắt buộc Axios gửi nguyên FormData trong RN
                });
            ...
            const errorMsg = error?.message || error?.error || 'Lỗi không xác định';
            Alert.alert('Lỗi', `Không thể upload ảnh. Chi tiết: ${errorMsg}`);
        } finally {
