    ...
    try {
      ...
      setError(
        Array.isArray(backendMessage)
          ? backendMessage.join(", ")
          : backendMessage || "Đăng ký thất bại. Email có thể đã tồn tại trên hệ thống!",
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="bg-white/80 dark:bg-zinc-900/80 backdrop-blur-2xl rounded-[2.5rem] p-8 sm:p-10 shadow-[0_8px_40px_rgb(0,0,0,0.08)] dark:shadow-[0_8px_40px_rgb(0,0,0,0.4)] border border-white/60 dark:border-white/10 relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-sm">
              Trở thành thành viên của cộng đồng ShopTech
            </p>
          </div>
          ...
          <div className="mt-8 relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-card text-muted-foreground">Hoặc đăng ký bằng</span>
            </div>
          </div>
